{
  ...
  ({
    lazy val derivedDiffer$macro$12: difflicious.Differ[difflicious.testtypes.RecursiveDerivedNode] =
      (new difflicious.differ.LazyDiffer[difflicious.testtypes.RecursiveDerivedNode]({
        val fieldDiffers: Vector[Tuple2[String, difflicious.Differ[Any]]] = scala.Vector
          ...
          .:+[Tuple2[String, difflicious.Differ[Any]]](
            Tuple2.apply[String, difflicious.Differ[Any]](
              "value",
              derivedDiffer$macro$13.asInstanceOf[difflicious.Differ[Any]],
            ),
          )
          .:+[Tuple2[String, difflicious.Differ[Any]]](
            Tuple2.apply[String, difflicious.Differ[Any]](
        ...
        (new difflicious.differ.ProductDiffer[difflicious.testtypes.RecursiveDerivedNode](
          fieldDiffers = fieldDiffers,
          isIgnored = false,
          typeName = (difflicious.utils.TypeName.apply[difflicious.testtypes.RecursiveDerivedNode](
            "difflicious.testtypes.RecursiveDerivedNode",
            "RecursiveDerivedNode",
            Nil,
          ): difflicious.utils.TypeName[difflicious.testtypes.RecursiveDerivedNode]),
          canUseEqualsValue =
    ...
    lazy val derivedDiffer$macro$14: difflicious.Differ[List[difflicious.testtypes.RecursiveDerivedNode]] = {
      ...
      (difflicious.differ.SeqDiffer.create[[X >: Nothing <: Any] =>> List[
        ...
        itemDiffer = derivedDiffer$macro$12,
        typeName = (difflicious.utils.TypeName.apply[List[difflicious.testtypes.RecursiveDerivedNode]](
          "List",
          "List",
          scala.List.apply[difflicious.utils.TypeName[_ >: Nothing <: Any]](
            difflicious.utils.TypeName
              .apply[Any]("difflicious.testtypes.RecursiveDerivedNode", "RecursiveDerivedNode", Nil),
          ),
        ): difflicious.utils.TypeName[List[difflicious.testtypes.RecursiveDerivedNode]]),
