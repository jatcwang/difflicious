...
sealed trait DifferUpdateError extends Throwable {
...
object DifferUpdateError {
  ...
  final case class UnrecognizedSubType(path: ConfigurePath, allowedTypes: Vector[String]) extends DifferUpdateError {
    override def errorMessage: String =
